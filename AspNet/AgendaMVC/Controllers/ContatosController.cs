...
namespace AgendaMVC.Controllers
{
   [Authorize]
    public class ContatosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Telefone,Cadastro")] Contato contato)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Telefone,Cadastro")] Contato contato)
        {
            if (id != contato.Id)
            {
                return NotFound();
